...
pageContext.setAttribute("n_idx", n_idx);
...
<script>
	...
	function modify_go(frm) {
			document.myForm.action="controller?type=N_Modify";
			document.myForm.submit();
	}
	
	function list_go() {
		location.href = "controller?type=N_List";
	}
	...
	<table>
		...
		<tbody>
			...
			<tr>
				<th>내용</th>
				<td>
					<textarea name="content" rows="8" cols="50" title="내용">${nvo.content }</textarea>
				</td>
			</tr>
			<!-- <tr>
				<th>패스워드</th>
